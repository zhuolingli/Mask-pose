...
def main():
    ...
    parser.add_argument('--video-path', type=str, help='Video path', default='论文_分析视频/GH010188_single.mp4')
    parser.add_argument(
        '--show',
        action='store_true',
        default=False,
    ...
    save_dict = {}
    save_dict['result'] = []
    save_dict['dataset_info'] =  dataset_info.keypoint_id2name 
    save_dict['video_fps'] = fps
    for frame_id, cur_frame in enumerate(mmcv.track_iter_progress(video)):
        ...
        save_dict['result'].append(pose_results)
        # show the results
...
if __name__ == '__main__':
    RESULT_SAVE_FILE = 'results_single_video.pkl'
    main()
